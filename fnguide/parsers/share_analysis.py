...
class FnGuideShareAnalysisParser:
    ...
    JSON_URLS = {
        "주주 상세": "https://comp.fnguide.com/SVO2/json/data/01_09_01/A{stock}.json?_={timestamp}",
        "주주변동내역": "https://comp.fnguide.com/SVO2/json/data/01_09_02/A{stock}.json?_={timestamp}"
    }
