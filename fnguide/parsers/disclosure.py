...
class FnGuideDisclosureParser:
    """
    FnGuide 거래소공시 파싱 클래스
    ...
    JSON_URLS = {
        "거래소 공시 [전체]": "https://comp.fnguide.com/SVO2/common/sp_read_json.asp?cmdText=menu_1_10&IN_GICODE=A{stock}&IN_KIND=0&IN_PAGE=1&_={timestamp}",
        "거래소 공시 [공정공시]": "https://comp.fnguide.com/SVO2/common/sp_read_json.asp?cmdText=menu_1_10&IN_GICODE=A{stock}&IN_KIND=1&IN_PAGE=1&_={timestamp}"
    }

    DETAIL_URL = "https://comp.fnguide.com/SVO2/asp/SVD_Disclosure_pop.asp?bullet_kind={bullet_kind}&bullet_no={bullet_no}"
    ...
    def parse(self, stock: str, report_type: str = "D"):
        """
        기업 정보 | 거래소공시 정보 추출 후 주요 키를 영어로 변환
