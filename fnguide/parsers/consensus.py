...
class FnGuideConsensusParser:
    ...
    JSON_URLS = {
        "실적&컨센서스 추이": "https://comp.fnguide.com/SVO2/json/data/01_06/01_A{stock}_A_{report_type}.json",
        "컨센서스 시계열 추이": "https://comp.fnguide.com/SVO2/json/data/01_06/02_A{stock}_A_{report_type}_FY1.json",
        "증권사별 적정주가 & 투자의견": "https://comp.fnguide.com/SVO2/json/data/01_06/03_A{stock}.json",
        "리포트요약": "https://comp.fnguide.com/SVO2/json/data/01_06/04_A{stock}.json"
    }
    ...
    def parse(self, stock: str, report_type: str = "D"):
        """
        기업 정보 | 컨센서스 정보 추출 후 주요 키를 영어로 변환
