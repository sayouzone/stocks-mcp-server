...
class FnGuideInvestParser:
    ...
    연결재무제표: https://comp.fnguide.com/SVO2/ASP/SVD_Invest.asp?pGB=1&gicode=A005930&cID=&MenuYn=Y&ReportGB=D&NewMenuID=105&stkGb=701
    별도재무제표: https://comp.fnguide.com/SVO2/ASP/SVD_Invest.asp?pGB=1&gicode=A005930&cID=&MenuYn=Y&ReportGB=B&NewMenuID=105&stkGb=701
    """

    # 테이블 유형 판별용 caption 패턴
    KEY_VALUE_CAPTIONS = {"주가관련 지표", "기업가치 지표"}
    ...
    def parse(self, stock: str, report_type: str = "D"):
        ...
        Args:
            ...
            report_type: D: 연결, B: 별도

        Returns:
            Dict: 컬럼명이 번역된 DataFrame
        """

        url = FNGUIDE_URLS.get("투자지표")
